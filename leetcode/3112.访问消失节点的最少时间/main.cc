...
void naiveDijkstra(vector<vector<pair<int, int>>>& g, vector<int>& dis) {}
void heapDijkstra(vector<vector<pair<int, int>>>& g, vector<int>& dis) {}
class Solution {
   public:
    ...
    vector<int> minimumTime(int n, vector<vector<int>>& edges,
        ...
        return dis;
        //学习自https://leetcode.cn/problems/minimum-time-to-visit-disappearing-nodes/solutions/2738888/dijkstra-suan-fa-pythonjavacgo-by-endles-7q6u/
    }
};
