...
class Util{
public:
    // static constexpr int mod = int(pow(10,9))+7;
    ...
    static constexpr ll base1 = 911382629;
    static constexpr ll mod1 = 1e18+3;
    static constexpr ll base2 = 3571428571;
    static constexpr ll mod2 = 1e18+7;


    static ll doubleHash(const std::string& s) {
        ll h1 = 0, h2 = 0;
        for(const char c : s) {
            h1 = (h1 * base1 + c) % mod1;
            h2 = (h2 * base2 + c) % mod2;
...
public:
    ...
    // 获取所有以给定前缀开头的键
    std::vector<std::vector<KeyType>> keysWithPrefix(const std::vector<KeyType>& prefix) const {
...
ll a,b,c,d,e,f,g,h;
ll l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;
const int size1 = 4'000'5;
// ll weight[size1];
// string ss[size1];
// ll value[size1];
ll a1[size1];
